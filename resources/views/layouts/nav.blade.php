								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion menu-active-bg">
												<div class="menu-item">
													<a class="menu-link {{ 'losarang' == request()->path() ? 'active' : '' }}" href="{{ url('losarang') }}">
														...
														<span class="menu-title">Data WIM</span>
													</a>
												</div>
											</div>
											<div class="menu-sub menu-sub-accordion menu-active-bg">
												<div class="menu-item">
													<a class="menu-link {{ 'losaranglidar' == request()->path() ? 'active' : '' }}" href="{{ url('losaranglidar') }}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Data LIDAR</span>
													</a>
												</div>
											</div>
										</div>
										...
										<div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item">
                                                <a class="menu-link {{ 'kulwaru' == request()->path() ? 'active' : '' }}" href="{{ url('kulwaru') }}">
                                                    ...
                                                    <span class="menu-title">Haikal Table</span>
                                                </a>
                                            </div>
										</div>
                                    ...
                                    {{-- <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-item">
                                                <a class="menu-link {{ 'haikal_table' == request()->path() ? 'active' : '' }}" href="{{ url('haikal_table') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Haikal Table</span>
        ...
        <script type="text/javascript">
            ...
            var table = $('.yajra-datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'WeighingDateTime', name: 'WeighingDateTime'},
                    {data: 'LicencePlate', name: 'LicencePlate'},
                    {data: 'Weight_wim', name: 'Weight_wim'},
                    {data: 'LimitWeight', name: 'LimitWeight'},
                    {data: 'OverWeight', name: 'OverWeight'},
                    {data: 'OverPercentage', name: 'OverPercentage'},
            ...
            var table = $('.yajra-datatable3').DataTable({
                ...
                columns: [
                    ...
                    {data: 'LidarLimitLength', name: 'LidarLimitLength'},
                    {data: 'LidarReadingLength', name: 'LidarReadingLength'},
                    {data: 'LidarOverLength', name: 'LidarOverLength'},
                    {data: 'LidarPercentageLength', name: 'LidarPercentageLength'},
                    {data: 'LidarLimitWidth', name: 'LidarLimitWidth'},
                    {data: 'LidarReadingWidth', name: 'LidarReadingWidth'},
                    {data: 'LidarOverWidth', name: 'LidarOverWidth'},
                    {data: 'LidarPercentageWidth', name: 'LidarPercentageWidth'},
                    {data: 'LidarLimitHeight', name: 'LidarLimitHeight'},
                    {data: 'LidarReadingHeight', name: 'LidarReadingHeight'},
                    {data: 'LidarOverHeight', name: 'LidarOverHeight'},
                    {data: 'LidarPercentageHeight', name: 'LidarPercentageHeight'},
                ],
                order: [[0,'asc']]
            });
